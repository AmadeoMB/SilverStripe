...
<head>
    ...
    <script>
        (function (d, s, id) {
            ...
            js.id = id;
            js.src =
                'https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.2&appId=702583676782987&autoLogAppEvents=1';
...
<body class="menu2 $ClassName">
    ...
    <script type="text/javascript">
        function () {}
        unction googleTranslateElementInit() {
    ...
    <div class="inline-menu-container style2 showx <% if $Blog %>dark <% end_if %>">
        ...
        <% else %>
        <a href="$BaseHref">
            <h3 class="logoH3">$SiteConfig.Title</h3>
        </a>
        <% end_if %>
...
exercitationem eaque laborum odit corrupti a dolorem ut nobis aperiam, magni 
expedita placeat consectetur itaque magnam velit similique voluptas quia sunt. --%>
